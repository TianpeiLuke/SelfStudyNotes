...
\item The \emph{\textbf{key}} point in author's argument is that developing a \emph{\textbf{principle center} of ourselves} is essential to form an \emph{\textbf{effective}}, \emph{\textbf{mature}}, \emph{\textbf{independent}} individual, which becomes the foundation for \emph{\textbf{trustworthy}}, \emph{\textbf{interdependent  relationships}} with others.
...
This chapter addresses the issue of ``\emph{\textbf{Desire}}" -- ``Do you \emph{\textbf{want to}} change?". The author raised the readers' \emph{\textbf{desire}} to commit to a paradigm shift in our character. It is argued that ``We are the \emph{Creator}." In particular, 
\begin{itemize}
...
This chapter addresses the issue of ``\emph{\textbf{Knowledge}}" -- ``\emph{\textbf{What}} principles / missions are you adopting in your life and \emph{\textbf{Why}}?" The author used the term ``\emph{\textbf{Begin with the End in Mind}}" to describe the practice of \emph{envisioning} the \emph{\textbf{personal mission} of life}. The author encouraged the readers to use their \emph{\textbf{imagination}} and \emph{\textbf{conscience}} to visualize and affirm an ideal image of themselves \emph{\textbf{in their minds}}. During this process, the readers can withdraw ineffective part of their lives. 

In this chapter, \emph{the main proposal} is to write a \emph{\textbf{personal mission statement}}, a \emph{personal constitution}. Such personal mission statement includes \emph{what you want to be}, \emph{to do} and \emph{the values or principles} upon which your identity and your actions are based. And the personal mission statement is separated according to \emph{\textbf{roles}} and \emph{\textbf{goals}}, which provides \emph{structual directions} to our personal mission. According to the author, ``\emph{with unchanging principles, we created a fundamental paradigm of effective living}". 

Behind the personal mission statement is our \emph{\textbf{centers}}. In particular, our centers are the source of \emph{four life-support factors}: \emph{\textbf{security}, \textbf{guidance}, \textbf{wisdom} and \textbf{power}}. In order to write \emph{personal mission statement}, we need to identify our \emph{\textbf{principle center}}, which is built upon the correct principles. By \emph{centering our life} on correct principles, we put various other centers and roles in our life (\emph{self, family, spouse, work, money, friend, enemy etc.}) into perspective and develop them in a balanced way. Note that these centers are at very center of our \emph{Circle of Influence}. 

Our \emph{personal mission statement} is a manifesto (\emph{the ``End"}) to our ideal \emph{principles} and \emph{values} \emph{in mind}, structured according to \emph{roles} and \emph{goals}.  It is our mental creation, which according to Habit 2, should comes first. \emph{\textbf{Personal leadership}} is to determine the right things to do. It provides us the direction of life and the criterion on our \emph{prioritization}, which is the focus on \emph{Personal Management}. According to the author, ``\emph{Personal Leadership comes before Personal Management.}"
