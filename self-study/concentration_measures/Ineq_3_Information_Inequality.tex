...
The inequality in \eqref{ineqn: sub_additivity_phi_entropy} or \eqref{ineqn: sub_additivity_phi_entropy_2} is also called the \emph{\textbf{tensoriztion of entropy}} in \citep{wainwright2019high}
\end{remark}
