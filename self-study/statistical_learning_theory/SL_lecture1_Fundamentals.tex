...
%The path of \emph{\textbf{discriminative learning}} suggests one focus on \emph{\textbf{learning the function relationship}} between sample and label. 


%The learning task in \emph{\textbf{derministic scenario}} is to \emph{\textbf{approximate}} $c \in \cC$ with $g \in \cH \subset \cC$ given samples $\cD$. The \emph{\textbf{function approximator}} $g$ should be ``\emph{\textbf{close}}" to the unknown $c$ \emph{under the unknown distribution} $P_{X}$.
