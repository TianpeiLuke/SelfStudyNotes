...
### Solving GMRES via Arnoldi Process
...
>[!important] Definition
>Consider the task of solving the **linear system of equations** $$Ax = b$$ where $A\in \mathbb{R}^{n\times n}$ is **unsymmetric** and $b\in \mathbb{R}^{n}$. 
>
...
>[!info]
>**GMRES** belongs to a family of **Krylov subspace methods**. 

- [[Krylov Subspace Methods]]
- [[Conjugate Gradient Normal Equation Residual and CGNR]]

![[Krylov Subspace Methods#^2c2024]]
