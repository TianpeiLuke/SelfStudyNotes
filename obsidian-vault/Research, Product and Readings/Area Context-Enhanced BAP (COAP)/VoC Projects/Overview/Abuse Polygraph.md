...
- Good contacts: concession related contacts from accounts with longer than 2 year tenure, placed more than 10 orders worth over $1000, only 1 concession, less than 5% SI, and in normal status.
  
**Algoritm**: fine tuned RoBERTa.

**Performance** on hold out dataset: AUC 0.99.

**Performance** on 7/1/2023 all concession related contacts: AUC 0.82
